...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-tr from-[#8EC5FC] to-[#E0C3FC]">
        <div className="container relative flex flex-col items-center gap-12 px-4 py-16">
